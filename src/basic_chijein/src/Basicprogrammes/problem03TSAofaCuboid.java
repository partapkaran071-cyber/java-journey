<<<<<<<< HEAD:src/basic_chijein/src/problems/problem03TSAofaCuboid.java
package basic_chijein.src.problems;
========
package basic_chijein.Basicprogrammes;
>>>>>>>> lecture-files:src/basic_chijein/Basicprogrammes/problem03TSAofaCuboid.java
...
public class problem03TSAofaCuboid {
    public static void main(String[] args) {
        ...
        //+ is used to print declared double or int
